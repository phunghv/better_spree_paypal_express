...
Gem::Specification.new do |s|
  ...
  s.test_files = ["spec/controllers/paypal_controller_spec.rb".freeze, "spec/features/paypal_spec.rb".freeze, "spec/models/pay_pal_express_spec.rb".freeze, "spec/spec_helper.rb".freeze]
